...
<div class="container emp-profile" style="margin-right:120px;width:890px">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php if(isset($_SESSION['type']))echo $_SESSION['type'] ;?></p>
                                            </div>
                                        </div>
...
<form method="post"  name="Form"  action="app/mod_ad.php" enctype="multipart/form-data">  
